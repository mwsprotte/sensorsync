...
public class ProjectMetadata implements Serializable {
    ...
    public long getNataNumber() {
        return nataNumber;
    }

    public void setNataNumber(long nataNumber) {
        this.nataNumber = nataNumber;
    }
